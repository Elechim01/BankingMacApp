...
//        Max Frame...
        .frame(width: getRect().width / 2.2, height: getRect().height - 130,alignment: .leading)
        ...
        VStack(alignment: .leading, spacing: 2) {
            ...
            VStack(spacing: 8){
                ForEach(histories) { hisotry in
                    ...
                    .padding(.vertical,5)
                    .padding(.horizontal)
                    .background(Color.white.opacity(currentHoverID == hisotry.id ? 1 : 0))
                    .cornerRadius(8)
//                    Hover Animation...
                    .onHover { status in
                        withAnimation {
                            if status {
                                currentHoverID = hisotry.id
                            }else{
                                currentHoverID = ""
                            }
                        }
